...
resource "google_project" "nino-salesforce-dev" {
  name       = "SalesForce-Dev"
  project_id = "nino-salesforce-dev"
...
# resource "google_project" "nino-salesforce-prod" {
#   name       = "SalesForce-Prod"
#   project_id = "nino-salesforce-prod"
